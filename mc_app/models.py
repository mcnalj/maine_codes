...
class UserProgress(models.Model):
    ...
    negativeFractionalExponentsAndNegativeCoefficientsPercentCorrect = models.IntegerField(default=100)
    ...
    negativeFractionalExponentsAndFractionalCoefficientsPercentCorrect = models.IntegerField(default=100)
